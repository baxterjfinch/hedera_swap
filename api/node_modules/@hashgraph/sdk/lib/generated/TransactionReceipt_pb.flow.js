/**
 * Flowtype definitions for TransactionReceipt_pb
...
declare export class TransactionReceipt mixins jspb.Message {
  getStatus(): $ElementType<
  ...
  getExchangerate(): ExchangeRate_pb.ExchangeRateSet | void;
  ...
  static toObject(
    ...
    msg: TransactionReceipt
  ): TransactionReceipt$AsObject;
  static extensions: {
...
export type TransactionReceipt$AsObject = {
  status: $ElementType<
    ResponseCode_pb.ResponseCodeEnumMap,
    $Keys<ResponseCode_pb.ResponseCodeEnumMap>
  >,
