...
proto.proto.TokenGetInfoQuery.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    token: (f = msg.getToken()) && BasicTypes_pb.TokenID.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.proto.TokenGetInfoQuery} returns this
*/
...
proto.proto.TokenGetInfoQuery.prototype.getToken = function() {
  return /** @type{?proto.proto.TokenID} */ (
    jspb.Message.getWrapperField(this, BasicTypes_pb.TokenID, 2));
};
...
proto.proto.TokenInfo.prototype.getTokenid = function() {
  return /** @type{?proto.proto.TokenID} */ (
    jspb.Message.getWrapperField(this, BasicTypes_pb.TokenID, 1));
};
...
proto.proto.TokenInfo.prototype.getSupplykey = function() {
  return /** @type{?proto.proto.Key} */ (
    jspb.Message.getWrapperField(this, BasicTypes_pb.Key, 11));
};
...
proto.proto.TokenInfo.prototype.getAutorenewaccount = function() {
  return /** @type{?proto.proto.AccountID} */ (
    jspb.Message.getWrapperField(this, BasicTypes_pb.AccountID, 15));
};
 ...
 * @return {!proto.proto.TokenGetInfoResponse} returns this
*/
