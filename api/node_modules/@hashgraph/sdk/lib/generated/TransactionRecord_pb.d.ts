...
export class TransactionRecord extends jspb.Message {
  ...
  getTransferlist(): BasicTypes_pb.TransferList | undefined;
  setTransferlist(value?: BasicTypes_pb.TransferList): void;

  clearTokentransferlistsList(): void;
  getTokentransferlistsList(): Array<BasicTypes_pb.TokenTransferList>;
  setTokentransferlistsList(value: Array<BasicTypes_pb.TokenTransferList>): void;
  addTokentransferlists(value?: BasicTypes_pb.TokenTransferList, index?: number): BasicTypes_pb.TokenTransferList;
...
export namespace TransactionRecord {
  export type AsObject = {
    ...
    transferlist?: BasicTypes_pb.TransferList.AsObject,
    tokentransferlistsList: Array<BasicTypes_pb.TokenTransferList.AsObject>,
  }
