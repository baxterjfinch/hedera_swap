 ...
 * @const
 */
proto.proto.TransactionRecord.repeatedFields_ = [11];
...
proto.proto.TransactionRecord.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    transferlist: (f = msg.getTransferlist()) && BasicTypes_pb.TransferList.toObject(includeInstance, f),
    tokentransferlistsList: jspb.Message.toObjectList(msg.getTokentransferlistsList(),
    BasicTypes_pb.TokenTransferList.toObject, includeInstance)
  };
...
proto.proto.TransactionRecord.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 10:
      var value = new BasicTypes_pb.TransferList;
      reader.readMessage(value,BasicTypes_pb.TransferList.deserializeBinaryFromReader);
      msg.setTransferlist(value);
      break;
    case 11:
      var value = new BasicTypes_pb.TokenTransferList;
      reader.readMessage(value,BasicTypes_pb.TokenTransferList.deserializeBinaryFromReader);
...
proto.proto.TransactionRecord.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      BasicTypes_pb.TransferList.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      11,
      f,
      BasicTypes_pb.TokenTransferList.serializeBinaryToWriter
    );
  }
};
...
proto.proto.TransactionRecord.prototype.getTransferlist = function() {
  return /** @type{?proto.proto.TransferList} */ (
    jspb.Message.getWrapperField(this, BasicTypes_pb.TransferList, 10));
};
...
proto.proto.TransactionRecord.prototype.getTokentransferlistsList = function() {
  return /** @type{!Array<!proto.proto.TokenTransferList>} */ (
    jspb.Message.getRepeatedWrapperField(this, BasicTypes_pb.TokenTransferList, 11));
};
...
proto.proto.TransactionRecord.prototype.clearTokentransferlistsList = function() {
  return this.setTokentransferlistsList([]);
};
